/* QRCode for JavaScript, Copyright (c) 2009 Kazuhiko Arase, MIT License.
   Browser bundle assembled from qrcode-terminal's vendored QRCode implementation. */
(function(global){
  'use strict';
  var modules = {
...
module.exports = QRCode;
  ...
  function requireModule(id){
    ...
    if (!modules[id]) throw new Error('Unknown QR module: '+id);
    var module = {exports:{}};
    cache[id]=module;
    modules[id](module,module.exports,requireModule);
    return module.exports;
  }
  global.GuestGuideQR = {QRCode:requireModule('./index'), QRErrorCorrectLevel:requireModule('./QRErrorCorrectLevel')};
})(window);
